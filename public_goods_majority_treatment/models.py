...
class Group(BaseGroup):
    ...
    tot_other_contri = models.FloatField(label="the group's other members' total contribution")
    ...
    def set_payoff_conditional(self):
        ...
        for i in range(0, 4):
                if A[i][j].participant.vars['conditional_round'] < 21:
        ...
        for i in range(0,4):
                ...
                for p in A[i]:
                    ...
                    if p.participant.vars['conditional_round'] < 21:
...
#it does not go through this
        ...
        self.session.vars['team_id'] = random.randint(0, Constants.num_team-1)
